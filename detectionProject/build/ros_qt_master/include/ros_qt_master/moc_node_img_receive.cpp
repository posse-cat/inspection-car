/****************************************************************************
** Meta object code from reading C++ file 'node_img_receive.hpp'
**
...
#include "../../../../src/ros_qt_master/include/ros_qt_master/node_img_receive.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'node_img_receive.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 26, 11), // "imageUpdate"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 14), // "loggingUpdated"
QT_MOC_LITERAL(4, 54, 11) // "rosShutdown"

    },
    "class1_ros_qt_demo::QNode\0imageUpdate\0"
    "\0loggingUpdated\0rosShutdown"
};
...
void class1_ros_qt_demo::QNode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QNode::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNode::imageUpdate)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void class1_ros_qt_demo::QNode::imageUpdate()
{
