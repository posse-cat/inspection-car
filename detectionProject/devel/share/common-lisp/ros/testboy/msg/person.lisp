...
(cl:defmethod cl:initialize-instance :after ((m <person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testboy-msg:<person> is deprecated: use testboy-msg:person instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testboy-msg:name-val is deprecated.  Use testboy-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'gender-val :lambda-list '(m))
(cl:defmethod gender-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testboy-msg:gender-val is deprecated.  Use testboy-msg:gender instead.")
  (gender m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testboy-msg:age-val is deprecated.  Use testboy-msg:age instead.")
  (age m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<person>)))
  ...
  "aee706d355638a90d939cda4116438f5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'person)))
  "Returns md5sum for a message object of type 'person"
  "aee706d355638a90d939cda4116438f5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<person>)))
  ...
  (cl:format cl:nil "string name~%uint8 gender~%uint8 age~%~%uint8 uknown=0~%uint8 male=1~%uint8 female=2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'person)))
  "Returns full string definition for message of type 'person"
  (cl:format cl:nil "string name~%uint8 gender~%uint8 age~%~%uint8 uknown=0~%uint8 male=1~%uint8 female=2~%~%~%"))
